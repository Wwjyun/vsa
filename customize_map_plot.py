...
def generate_map(df, output_path, map_size=(20, 20), title_fontsize=20, margin=dict(l=0.07, r=0.93, b=0.07, t=0.93)):
    ...
    myPlot.on('plotly_legendclick', function(data) {{
        ...
        var percentage = (red_points / 96721 * 100).toFixed(2);
