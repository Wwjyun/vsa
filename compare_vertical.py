...
from vsa_paths import STAGE_SEQUENCE, map_image_path


def vertical_comparison(main_ui):
    ...
    for button_name in button_names:
        image_path = map_image_path(option, number, button_name, code)
        image_paths[button_name] = image_path if image_path.is_file() else None
    ...
    for i, button_name in enumerate(button_names):
        ...
        if image_paths[button_name]:
            ...
            print(f"No image found for {button_name}, leaving space blank.")
